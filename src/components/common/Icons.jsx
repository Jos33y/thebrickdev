...
// Prospects Icon - Target/crosshair for pipeline
export const ProspectsIcon = ({ size = 24, className = '' }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
/**
 * ADDITIONAL ICONS TO ADD TO Icons.jsx
 * 
